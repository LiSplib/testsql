    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark text-white">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="navbar-nav mr-auto d-flex justify-content-center" style="font-size: 1.5em;">
                ...
                <a class="nav-item nav-link" href="ajout_patient.php">Création patient</a>
                <a class="nav-item nav-link" href="liste-patients.php">Liste des patients</a>
                <a class="nav-item nav-link" href="ajout-rendezvous.php">Ajout rendez-vous</a>
            ...
            <form class="form-inline my-2 my-lg-0" action="search.php">
                    ...
                    <button class="btn btn-info my-2 my-sm-0" type="submit" name="form_submit">
                        <svg class="bi bi-search" width="1.5em" height="1.5em" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
